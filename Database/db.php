...
$computers = [
    new Desktop('IMac 24', 'Display Retina 24" 4.5k', 'hardisk IMac 24', '8-core', './assets/img/imac_24.png', 'no case', 'Magic Keyboard con Touch ID', 'Magic Mouse',),
    new Desktop('Mac PRO', 'no monitor', 'hardisk MAC PRO', '28-core', './assets/img/mac_pro.png', 'Mac Pro Case', 'Magic Keyboard con Touch ID (argento e nero)', 'Magic Mouse (argento e nero)'),
